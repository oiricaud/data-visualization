...
class CI_Session {
    ...
    var $sess_table_name			= '';
    var $sess_expiration			= 10;
    var $sess_expire_on_close		= TRUE;
    var $sess_match_ip				= FALSE;
    var $sess_match_useragent		= TRUE;
    var $sess_cookie_name			= 'cisession';
    var $cookie_prefix				= '';
    var $cookie_path				= '';
    var $cookie_domain				= '';
    ...
    function sess_update()
    {
        ...
        if ($this->CI->input->is_ajax_request() OR ($this->userdata['last_activity'] + 600) >= ($this->now))
        {

            /* Change the 600 to increase time
              echo $this->CI->input->is_ajax_request();
              echo  ($this->userdata['last_activity']);
              echo " + ";
              echo  $this->sess_time_to_update;
              echo ">=";
              echo  $this->now;
             */
            return;
